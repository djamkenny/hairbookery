      ...
      <main className="flex-grow flex items-center justify-center py-20">
        <div className="container max-w-xl px-4">
          <div className="text-center mb-8 animate-fade-in">
            ...
            <h1 className="text-3xl font-semibold mb-2">Stylist Registration</h1>
            <p className="text-muted-foreground">Join our platform to connect with clients and grow your business</p>
          </div>
