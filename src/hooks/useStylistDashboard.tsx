...
export const useStylistDashboard = () => {
  ...
  useEffect(() => {
    ...
    const handleProfileUpdate = () => {
      console.log("Profile update event received, refreshing dashboard data...");
      fetchUserData();
    };
    
    window.addEventListener('stylist-profile-updated', handleProfileUpdate);
    
    return () => {
      window.removeEventListener('stylist-profile-updated', handleProfileUpdate);
    };
  }, [fetchUserData]);
